...
const templates = {
  autocomplete: {
    // Algolia logo
    footer: (translations, locale, subdomain, poweredBy) => {
      const [poweredByAlgoliaPre, poweredByAlgoliaPost] = translate(
        translations,
        locale,
        'searchByAlgolia',
        '_algolia_'
      ...
      return (
        <Fragment>
          <footer class="aa-PanelFooter">
            <ul class="aa-Commands">
              <li>
                <span class="aa-Key">
                ...
                <span class="aa-Label">
                  {translate(translations, locale, 'toSelect')}
                </span>
              </li>
              <li>
                <span class="aa-Key">
                ...
                <span class="aa-Label">
                  {translate(translations, locale, 'toNavigate')}
                </span>
              </li>
              <li>
                <span class="aa-Key">
                ...
                <span class="aa-Label">
                  {translate(translations, locale, 'toClose')}
                </span>
              </li>
            </ul>
            {poweredBy && (
              ...
              >
                <span class="aa-Label">{poweredByAlgoliaPre}</span>
                <svg class="aa-Logo" width="77" height="19">
                  <path
                ...
                <span class="aa-Label">{poweredByAlgoliaPost}</span>
              </a>
            )}
          </footer>
        </Fragment>
